...
Уеб API за музикален каталог, позволяващ управление на артисти, албуми, песни, плейлисти, награди, жанрове и настроения. 

**Типове потребители:**
- **Consumer** - обикновен потребител (може да създава плейлисти)
- **Admin** - администратор (пълен CRUD достъп)
